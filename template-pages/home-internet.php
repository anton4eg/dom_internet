<?php
/*
 * Template Name: Домашний интернет
 */
...
?>
    ...
    <div class="main-wrapper house-inet">
        ...
        <main class="content">
            <section class="main-picture">
                <div class="wrapper">
                    <div class="main-picture__box">
                        <h1 class="main-title">
                            ДОМАШНИЙ ИНТЕРНЕТ <br> И ТЕЛЕВИДЕНИЕ
                        </h1>
						...
						<section class="main-picture-list main-picture-list_mod">
                ...
                <div class="wrapper">
                    ...
                    <ul class="internet-list">
                        <li class="internet-list__item">
                            <a href="" class="internet-list__link">
                        ...
                        <li class="internet-list__item">
                            <a href="" class="internet-list__link">
                               <div class="follower-wrapper">
                                ...
                                <span>Интернет TB приставка</span>
                            </a>
                        </li>
                        <li class="internet-list__item">
                            <a href="" class="internet-list__link">
            ...
            <section class="scheme">
                <div class="wrapper">
                    <div class="inet-scheme__text">
                        <p>
                            Выбор оборудования для установки определяется: качеством покрытия сети, расстоянием до вышки связи и её мощности, высоты монтажа, особенностей местности. Стандартный монтаж оборудования и выход в интернет осуществляется в течении двух часов. Выбор оборудования для установки определяется: качеством покрытия сети, расстоянием до вышки связи и её мощности, высоты монтажа, особенностей местности. Стандартный монтаж оборудования и выход в интернет осуществляется в течении двух часов.
                        </p>
                    </div>
