...
?>
    ...
    <div class="main-wrapper video-dacha">
        ...
        <main class="content">
                ...
                <div class="wrapper">
                    <h3 class="title">
												ПОЧЕМУ СТОИТ УСТАНАВЛИВАТЬ ВИДЕОНАБЛЮДЕНИЕ
										</h3>
										<div class="special-box">
											...
											<div class="special-wrap full-photo">
												<div class="special-wrap__photo">
													<img class="js-img-lazy" data-src="img/video-dacha-1.jpg" src="/" alt="img">
												</div>
											</div>
										</div>
                       ...
                       ВИДЕОНАБЛЮДЕНИЕ ДЛЯ ЧАСТНОГО ДОМА
                        ...
                        <ul class="observation-box__list">
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    Наименование
                                </div>
                                <div class="observation-box__right">
                                    Цена за штуку
                                </div>
                            </li>
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link">
                                        Камера AHD, 1 Мегапиксель, день/ночь, внутренняя 
                                    </a>
                                </div>
                                <div class="observation-box__right">
                                    3500
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link"> 
                                        Бесперебойный блок питания FE-1250, 12В, 5А  
                                    </a>
                                </div>
                                <div class="observation-box__right">
                                    3500
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link">
                                        Подключение видеорегистратора с удаленным доступом  
                                    </a>
                                </div>
                                <div class="observation-box__right">
                                    4000
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link"> Крепежный набор</a>
                                </div>
                                <div class="observation-box__right">
                                    1000
                                </div>
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link">
                                        ...
                                        FE-5108MHD 8-ми канальный гибридный (AHD, TVI, CVI, IP, CVBS)
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link"> 
                                        Камера AHD, 2 Мегапикселя, день/ночь, уличная
                                    </a>
                                </div>
                                <div class="observation-box__right">
                                    4500
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link"> 
                                        Камера AHD, 2 Мегапикселя, день/ночь, уличная, 30м, увелич.
                                    </a>
                                </div>
                                <div class="observation-box__right">
                                    7500
                            ...
                            <li class="observation-box__item">
                                <div class="observation-box__left">
                                    <a href="#" class="observation-box__link">
                                        Кабель видео с протяжкой и креплением в черной гофре
                                    </a>
                                </div>
                                <div class="observation-box__right">
                                    120
