        ...
        <main class="content">
            ...
            <section class="rate">
                <div class="wrapper">
										...
										<div class="tarif-table-wrap tarif-table-wrap_mod tarif-table-wrap_mod-styled">
											<table class="tarif-table">
												...
												<tbody>
													<tr>
														...
														<td class="rate-table__td">
																900 <i class="icon-rub"></i> / мес.
														</td>
														<td class="rate-table__td">
																300 Мбит/с
														</td>
														<td class="rate-table__th">
																Полностью безлимитный тариф на мобильный интернет. Никаких ограничений по трафику и скорости. Работает в стандартах 2G/3G/4g. 
														</td>
														<td class="rate-table__td">
																500 <i class="icon-rub"></i>
														</td>
													</tr>
													<tr>
														<td class="rate-table__th">
														...
														<td class="rate-table__td">
																675 <i class="icon-rub"></i> / мес.
														</td>
														<td class="rate-table__td">
																До 1 00 Мбит/с
														</td>
														<td class="rate-table__th">
																Тариф на мобильный интернет по выгодной стоимости. Без ограничения по скорости. Работает в стандартах 2G/3G/4G. Действует по всей России, кроме Дальнего Востока и Крыма. Абонентская плата - 675 руб/мес. Объем включенного трафика: 50 гигабайт.
														</td>
														<td class="rate-table__td">
																500 <i class="icon-rub"></i>
														</td>
                        ...
                        <form class="scheme-box__form">
                            ...
                            <div class="scheme-form__box">
                                <select class='order-form__select order-form__select-js' data-placeholder='Выбрать регион'>
                                    get_template_part('/template-parts/popups.php"');                       <option></option>
