<?php
/*
 * Template Name: Интернет - в загородный дом
 */
...
?>
    ...
    <div class="main-wrapper vkotedji">
        ...
        <main class="content">
            <section class="main-picture">
                ...
                <div class="wrapper">
                    <h3 class="title">
												ПОДКЛЮЧИТЬ ИНТЕРНЕТ  В ЗАГОРОДНЙ ДОМ
										</h3>
										<div class="special-box">
											...
											<div class="special-wrap full-photo">
												<div class="special-wrap__photo">
													<img class="js-img-lazy" data-src="img/hand.jpg" src="/" alt="img">
												</div>
											</div>
										</div>
                            ...
                            <li class="main-slider__el">
                                ...
                                <div class="main-slider__text">
                                    Установка в <br> день заказа
										...
										<div class="special-text mod">Выбор оборудования для установки определяется: качеством покрытия сети, расстоянием до вышки связи и её мощности, высоты монтажа, особенностей местности. Стандартный монтаж оборудования и выход в интернет осуществляется в течении двух часов. Выбор оборудования для установки определяется: качеством покрытия сети, расстоянием до вышки связи и её мощности, высоты монтажа, особенностей местности. Стандартный монтаж оборудования и выход в интернет осуществляется в течении двух часов.</div>
                </div>
            </section>
						
            <section class="scheme new-form">
                <div class="wrapper">      
